...
import type { Contest, ContestConfiguration, ContestParticipant, PickCard } from '../../domain/src/index.js';
...
export interface StoredContest { contest: Contest; configuration: ContestConfiguration; participants: Record<string, ContestParticipant>; cards: Record<string, PickCard> }
