...
export function Contest({ id }: { id: string }) {
  ...
  if(display&&['REVEAL','LIVE','MAIN_EVENT','FINAL'].includes(view.contest.phase))return <main className="display live-shell"><GameDay id={id} config={view.configuration} admin={false} shared/></main>;
